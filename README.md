...
* [*SafLighter*](https://github.com/FLA-Coding/SafLighter) is a tiny Safari extension (developed in Swift, JavaScript, HTML and CSS) which allows to highlight text on any webpage. It is still in beta.
